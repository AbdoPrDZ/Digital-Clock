...
def asset(name: str) -> str:
  ...
  Example:
      >>> font_path = asset("DIGITALDREAM.ttf")
...
def register_font(font_path: str) -> str:
  ...
  Example:
      >>> font_name = register_font(r"C:\path\to\DIGITALDREAM.ttf")
      >>> print(font_name)  # "DIGITALDREAM"
...
def get_font_config(family: str, size: int, **kwargs) -> tkFont.Font:
  ...
  Args:
      family (str): The font family name (e.g., "DIGITALDREAM", "Arial")
  ...
  Example:
      >>> font = get_font_config("DIGITALDREAM", 24, weight="bold")
